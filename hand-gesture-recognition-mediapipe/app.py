...
def main():
    ...
    # setup for tkinter
    root = tk.Tk() # creates the tinker object
    width = root.winfo_screenwidth() # gets the screen width
    height = root.winfo_screenheight() # gets the screen height
    ...
    hands = mp_hands.Hands(
        ...
        max_num_hands=2, # changing the number of hand that can be recognized
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                # printing the landmark screen coordinates
                #print(landmark_list)
